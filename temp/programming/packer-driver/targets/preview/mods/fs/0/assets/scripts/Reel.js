  ...
  return {
    ...
    execute: function () {
      ...
      _export("Reel", Reel = (_dec = ccclass('Reel'), _dec(_class = (_class2 = (_temp = class Reel extends Component {
        ...
        update(dt) {
          if (this._spinning) {
            var deltaY = this.reelSpeed * dt * this._direction;
        ...
        swapSymbol() {
          var lastSymbolIndex = this._direction == 1 ? this.node.children.length - 1 : 0;
          var lastSymbol = this.node.children[lastSymbolIndex];
